...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
        ...
        <!-- //header-ends -->
            <div id="page-wrapper">
                <form action="{{ url('/penerimaan/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-control text full-size">
                                            <input class="form-control" type="text" name="nama_penerima" id="nama_penerima" autocomplete="off">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-control text full-size">
                                            <textarea class="form-control" type="text" name="no_tlp" id="no_tlp" autocomplete="off"></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" name="jumlah" id="jumlah" value="1000000" autocomplete="off" readonly>
                                        </div>
                                    </td>
                                </tr>
